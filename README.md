...
Проект собирает публично доступные данные о вакансиях с hh.ru для аналитики рынка труда и решает ключевую техническую проблему — лимит в 2000 результатов на поисковый запрос.
